...
The selected [frontend work](/work/) on this site uses a restrained card system so project summaries and focus areas remain the primary content.
...
Visitors ready to discuss a project can use the [contact page](/contact/), while those comparing capabilities can review [frontend engineering services](/services/).
