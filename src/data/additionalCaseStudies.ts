  ...
  en: [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            'A desktop Lighthouse 13.4.1 navigation run on September 10, 2026 measured the production homepage in Chrome 152 at 100 for Performance, Accessibility, Best Practices, SEO, and Agentic Browsing. It reported First Contentful Paint at 0.4 seconds, Largest Contentful Paint at 0.6 seconds, Total Blocking Time at 0 milliseconds, Cumulative Layout Shift at 0, and Speed Index at 0.8 seconds.',
            'The measured transfer payload was 190 KiB and script boot-up time rounded to 0.0 seconds. These figures describe one desktop laboratory run, not field data, and do not guarantee results across mobile devices, networks, locations, browser states, or future deployments.',
          ],
          bullets: [
            'Performance: 100',
            'Accessibility: 100',
            ...
            'FCP: 0.4 s · LCP: 0.6 s · TBT: 0 ms · CLS: 0 · Speed Index: 0.8 s',
            'Payload: 190 KiB · Lighthouse 13.4.1 · Chrome 152',
          ],
        },
      ],
      outcomes: [
  ...
  es: [
    {
      ...
      sections: [
        ...
        {
          id: 'lab-results',
          heading: 'Resultados de laboratorio en escritorio',
          body: [
            'Una prueba de navegación de escritorio con Lighthouse 13.4.1, realizada el 10 de septiembre de 2026, midió la página principal de producción en Chrome 152 con 100 en Rendimiento, Accesibilidad, Buenas prácticas, SEO y Navegación agéntica. Registró FCP de 0,4 segundos, LCP de 0,6 segundos, TBT de 0 milisegundos, CLS de 0 y Speed Index de 0,8 segundos.',
            'La transferencia medida fue de 190 KiB y el tiempo de inicio de scripts se redondeó a 0,0 segundos. Son resultados de una sola prueba de laboratorio en escritorio, no datos de campo, y pueden variar según dispositivo, red, ubicación, estado del navegador y futuras versiones.',
          ],
          bullets: [
            'Rendimiento: 100',
            'Accesibilidad: 100',
            ...
            'SEO: 100',
            'Navegación agéntica: 100',
            'FCP: 0,4 s · LCP: 0,6 s · TBT: 0 ms · CLS: 0 · Speed Index: 0,8 s',
            'Transferencia: 190 KiB · Lighthouse 13.4.1 · Chrome 152',
          ],
        },
      ],
      outcomes: [
  ...
  ar: [
    {
      ...
      sections: [
        ...
        {
          id: 'lab-results',
          heading: 'نتائج الاختبار المعملي على سطح المكتب',
          body: [
            'قاس اختبار تنقل مكتبي باستخدام Lighthouse 13.4.1 بتاريخ 10 سبتمبر 2026 الصفحة الرئيسية المنشورة في Chrome 152، وسجل 100 في الأداء وإمكانية الوصول وأفضل الممارسات وSEO والتصفح الوكيلي. بلغ FCP مقدار 0.4 ثانية وLCP مقدار 0.6 ثانية وTBT مقدار 0 مللي ثانية وCLS مقدار 0 وSpeed Index مقدار 0.8 ثانية.',
            'بلغ حجم النقل المقاس 190 KiB، وتقرب وقت بدء تشغيل scripts إلى 0.0 ثانية. تصف هذه الأرقام اختبارًا معمليًا واحدًا على سطح المكتب وليست بيانات ميدانية، وقد تختلف حسب الجهاز والشبكة والموقع وحالة المتصفح والإصدارات المستقبلية.',
          ],
          bullets: [
            'الأداء: 100',
            'إمكانية الوصول: 100',
            ...
            'SEO: 100',
            'التصفح الوكيلي: 100',
            'FCP: 0.4 ثانية · LCP: 0.6 ثانية · TBT: 0 مللي ثانية · CLS: 0 · Speed Index: 0.8 ثانية',
            'حجم النقل: 190 KiB · Lighthouse 13.4.1 · Chrome 152',
          ],
        },
      ],
      outcomes: [
